            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <div class="flex items-center space-x-3 mb-4">
                        <img src="images/wof_logo.png" alt="Whoba Ogo Foundation" class="h-8 w-auto">
                        <h3 class="text-lg font-semibold"><?php echo APP_NAME; ?></h3>
                    </div>
                    <p class="text-gray-400">Touching lives through medical and educational support in rural African communities.</p>
                    <p class="text-sm text-coral mt-2 font-medium">...touching lives</p>
                </div>
                <div>
